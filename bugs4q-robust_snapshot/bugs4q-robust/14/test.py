...
class Test(unittest.TestCase):
    def test_14(self):
        exval, qval, shots = module.run()
        delta_real = compute_component_delta(exval.real, total_shots=shots)
        delta_imag = compute_component_delta(exval.imag, total_shots=shots)
